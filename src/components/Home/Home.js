...
class Home extends React.Component{
    state = {
      ...
      getSelectedVideo = (videoId) =>{
        axios
        .get(`${API_URL}/videos/${videoId}?api_key=${API_KEY}`).then((response) =>{
    ...
    componentDidMount(){
      ...
      axios
      .get(`https://project-2-api.herokuapp.com/videos?api_key=105f6357-1dac-4475-9750-00701622824d`).then((response) =>{
          console.log(response.data)
        ...
        return ( 
            ...
            <div className="wrapper">
              ...
              <section className="wrapper__videos">
                ...
                {this.state.selectedVideo && (<NextVideo

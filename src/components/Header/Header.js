...
class Header extends Component {
    render() {
        ...
        <form className= "header__form">
          <input type= "text" className="header__search" name="user_search" placeholder="Search">

            {/* <button className= "header__search-img" type= "submit">
          ...
          <div className= "header__form-sub-wrapper">
            ...
            <button className="header__button" type="submit"><img className= "header__button-img" src= {ButtonImg} alt= "button plus sign"/> UPLOAD</button>
